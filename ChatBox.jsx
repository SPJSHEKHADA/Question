    ...
    return (
      <div className="flex justify-center items-center py-4 bg-gray-50 border-t">
        <div className="flex items-center space-x-2">
          <button
            className={`flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${currentPage === 1
          ...
          <button
            className={`flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${currentPage === totalPages
                ? "text-gray-400 cursor-not-allowed"
                : "text-gray-700 hover:bg-gray-100 hover:text-gray-900"
              }`}
            onClick={() => handlePageClick(currentPage + 1)}
  ...
  const renderMessage = (msg, index) => {
    ...
    return (
      <>
        ...
        >
          <div
            className={`relative max-w-[75%] lg:max-w-[60%] p-3 rounded-2xl shadow-sm ${isSent
          ...
          <div className="flex flex-col h-full">
            <div className="flex gap-3 mb-6">
              {[
                ...
                <button
                  key={key}
                  className={`flex items-center px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-sm ${currentStatus === key
                    ...
                    {filteredTickets.length === 0 ? (
                      ...
                      <div className="divide-y divide-gray-100">
                        {filteredTickets.map((ticket) => (
                          <div
                            key={ticket.id}
                            className={`p-4 hover:bg-gray-50 cursor-pointer transition-all duration-200 ${currentTicketId === ticket.id ? "bg-[#f0f9ff] border-r-4 border-[#075e54]" : ""
                              }`}
                            onClick={() =>
                              openTicketChat({
                                id: ticket.id,
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-start mb-1">
                                  ...
                                  <span
                                    className={`text-xs px-2 py-1 rounded-full font-medium ${ticket.status === "open"
                  ...
                  <div className="p-4 bg-gradient-to-r from-[#075e54] to-[#128c7e] flex justify-between items-center shadow-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="text-white">
                        ...
                        <div className="font-thin text-sm leading-tight text-white/80">
                    ...
                    {showUserDetails && (
                      <>
                        ...
                        />
                        <div
                          className={`fixed right-0 top-0 h-full w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${showUserDetails ? "translate-x-0" : "translate-x-full"
                            }`}
                        >
                      ...
                      <div className="flex items-end space-x-3 bg-white rounded-2xl p-3 shadow-sm">
                        ...
                        <div className="flex-1">
                          <textarea
                            ...
                            className="w-full min-h-[40px] max-h-[120px] p-2 rounded-xl bg-transparent text-gray-800 placeholder-gray-500 focus:outline-none resize-none no-scrollbar"
                            rows="1"
                          />
                        </div>
